...
class QrcodeReaderViewState extends State<QrcodeReaderView>
  ...
  Widget build(BuildContext context) {
    final flashOpen = Image.asset(
      "assets/qr_reader/tool_flashlight_open.png",
    ...
    final flashClose = Image.asset(
      "assets/qr_reader/tool_flashlight_close.png",
      // package: "flutter_qr_reader",
      width: 35,
      height: 35,
      color: Colors.white,
            ...
            Positioned(
              ...
              child: Align(
                ...
                child: DefaultTextStyle(
                  ...
                  child: widget.helpWidget ?? Text("s63".tr),
                ),
              ),
            ),
            Positioned(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    alignment: Alignment.center,
                    child: Image.asset(
                      "assets/qr_reader/tool_qrcode.png",
                      // package: "flutter_qr_reader",
                      width: 35,
                      height: 35,
                      color: Colors.white54,
